                ...
                <div class = "product-collection-wrapper">
                    ...
                    <div class = "product-col-right">
                        <div class = "product-col-r-top flex">
                            ...
                            <h2 class = "md-title"> Customer satisfaction is defined as a measurement that determines how happy customers are with a company’s products, services, and capabilities. Customer satisfaction information, including surveys and ratings, can help a company determine how to best improve or changes its products and services.

An organization’s main focus must be to satisfy its customers. This applies to industrial firms, retail and wholesale businesses, government bodies, service companies, nonprofit organizations, and every subgroup within an organization. </h2> 
                        ...
                        <div class = "product-col-r-bottom">
                            ...
                            <div class = "flex">
                                <div class = "product-col-content">
                                    ...
                                    <button type = "button" class = "btn-dark"> 
                                    <a href="discount.html"> Click For Discount </a>
                                 </button>
                                </div>
                            </div>
                            <!-- right -->
                            <div class = "flex">
                                <div class = "product-col-content">
                                    <h2 class = "sm-title"> Recommended For You </h2>
                                    <h2 class = "md-title"> Check Our Recommendations For You </h2>
                                    <p class = "text-light">Check the products we are recommending for you , we want our customers to get the laters products according to their buying history . We want them to get the products they should be looking for</p>
                                    <button type = "button" class = "btn-dark"> 
                                    <a href="rec.html"> Recommendation </a>
                                    </button>
                                </div>
                            </div>
                        </div>
